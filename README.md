...
This repository hosts the **deployed static build** (published to the `gh-pages` branch by CI). The sources live in a separate private repository.

## Features
- Three intelligent removal paths: transparent-trim, solid-colour flood-fill, and on-device AI segmentation.
- Before/after comparison slider and custom studio background colours.
